			...
			function delMoreProduct(){
				...
				for (var i = 0; i < dels.length; i++) {
					if(dels[i].checked == true){
						arr.push(dels[i].getAttribute("value"));
					}
					
				}
				var isdel =  confirm("你确定要删除这些信息");
				if(isdel){
					location.href = "${pageContext.request.contextPath}/adminDelMoreProduct?pid="+arr;
				}
...
<body>
  ...
  <form id="Form1" name="Form1"
    ...
    </select>&nbsp;&nbsp; 商品类型:<select id="cid" name="cid">
      <option value="">不限</option>
      <c:forEach items="${categoryList }" var="category">
         <option value="${category.cid }">${category.cname }</option>
      </c:forEach>
     
    </select>&nbsp;&nbsp; <input type="submit" value="搜索"> <br>
      ...
      <TBODY>
        ...
        <tr>
          <td class="ta_01" align="right">
            ...
            <button type="button" value="删除选中"
              onclick="delMoreProduct()">删除选中</button>
              ...
              <c:forEach items="${productList }" var="pro"
                ...
                <tr onmouseover="this.style.backgroundColor = 'white'"
                  ...
                  <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                    width="18%"><input type="checkbox" class="dels"
                    name="deletes" value="${pro.pid }">${vs.count }</td>
                  <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                  ...
                  <td align="center" style="HEIGHT: 22px"><a
                    ...
                    onclick="delProduct('${pro.pid}')"> <img
